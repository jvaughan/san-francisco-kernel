...
static void lcdc_himax_sleep(void)
{
         gpio_lcd_emuspi_write_one_para(0x0102, 0x180);
         mdelay(40);
         gpio_lcd_emuspi_write_one_para(0x0007, 0x0000);
         mdelay(40);
         gpio_lcd_emuspi_write_one_para(0x0100, 0x0004);
     

         gpio_lcd_emuspi_write_one_para(0x1F, 0x02);
         mdelay(10);
         gpio_lcd_emuspi_write_one_para(0x1F, 0x0A);
         mdelay(10);
         
         gpio_lcd_emuspi_write_one_para(0x1C, 0x40);
         mdelay(10);
         

         gpio_lcd_emuspi_write_one_para(0x1F, 0x0B);
         mdelay(10);
         

         gpio_lcd_emuspi_write_one_para(0x19, 0x90);
         mdelay(10);                
...
static void lcdc_himax_init(void)
{
	...
	gpio_lcd_emuspi_write_one_para(0x31, 0x03); 
