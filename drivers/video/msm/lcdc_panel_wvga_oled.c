...
--------     ----       -----------------------------                --------------------------
2010-11-02   luya    	modify bkl for 729VV	 		 			ZTE_LCD_LUYA_20101102_01
...
static boolean can_adjustbkl = false;		////ZTE_LCD_LUYA_20101102_01
...
static void lcdc_set_bl(struct msm_fb_data_type *mfd)
{
    ...
    if(!can_adjustbkl)		////ZTE_LCD_LUYA_20101102_01
    {
	    can_adjustbkl = true;
	    return;
    }
...
static LCD_PANEL_TYPE lcd_panel_detect(void)
{
	...
	*/
	...
	//gpio_lcd_lead_emuspi_write_one_index(0x3b00,0x00);
