...
static struct mt9t11x_i2c_reg_conf const prev_snap_tbl[] = {
    ...
    {0x098A, 0x92E6, WORD_LEN, 0}, 	
    {0x0990, 0x00A9, WORD_LEN, 0}, 	
    {0x098E, 0x0010, WORD_LEN, 0}, 	
    {0x0990, 0x0E00, WORD_LEN, 0}, 	
    {0x098E, 0x0003, WORD_LEN, 0}, 	
    {0x0990, 0x0004, WORD_LEN, 50}, 
...
static struct mt9t11x_i2c_reg_conf const wb_auto_tbl[] = {
    ...
    {0x0990, 0x0015, WORD_LEN, 0},            // MCU_DATA_0
    {0x098E, 0x48DA, WORD_LEN, 0},           // MCU_ADDRESS [CAM1_AWB_CCM_RL_10]
    {0x0990, 0xFFF2, WORD_LEN, 0},            // MCU_DATA_0
#else
    {0x098E, 0x48C2, WORD_LEN, 0}, 	// MCU_ADDRESS [CAM1_AWB_CCM_L_9]
    {0x0990, 0x0019, WORD_LEN, 0}, 	// MCU_DATA_0
    {0x098E, 0x48C4, WORD_LEN, 0}, 	// MCU_ADDRESS [CAM1_AWB_CCM_L_10]
...
#if defined(CONFIG_MACH_BLADE) || defined (CONFIG_MACH_SMOOTH)    
    {0x3640, 0x0270, WORD_LEN, 0}, 	// P_G1_P0Q0
    {0x3642, 0xE1CA, WORD_LEN, 0}, 	// P_G1_P0Q1
    {0x3644, 0x0EB2, WORD_LEN, 0}, 	// P_G1_P0Q2
    {0x3646, 0x8A4E, WORD_LEN, 0}, 	// P_G1_P0Q3
    {0x3648, 0xFDD1, WORD_LEN, 0}, 	// P_G1_P0Q4
    {0x364A, 0x0350, WORD_LEN, 0}, 	// P_R_P0Q0
    {0x364C, 0xD68A, WORD_LEN, 0}, 	// P_R_P0Q1
    {0x364E, 0x06D2, WORD_LEN, 0}, 	// P_R_P0Q2
    {0x3650, 0x2F8A, WORD_LEN, 0}, 	// P_R_P0Q3
    {0x3652, 0xC131, WORD_LEN, 0}, 	// P_R_P0Q4
    {0x3654, 0x01B0, WORD_LEN, 0}, 	// P_B_P0Q0
    {0x3656, 0x9C0A, WORD_LEN, 0}, 	// P_B_P0Q1
    {0x3658, 0x7891, WORD_LEN, 0}, 	// P_B_P0Q2
    {0x365A, 0xC38B, WORD_LEN, 0}, 	// P_B_P0Q3
    {0x365C, 0xCCD1, WORD_LEN, 0}, 	// P_B_P0Q4
    {0x365E, 0x00B0, WORD_LEN, 0}, 	// P_G2_P0Q0
    {0x3660, 0xA08B, WORD_LEN, 0}, 	// P_G2_P0Q1
    {0x3662, 0x0AF2, WORD_LEN, 0}, 	// P_G2_P0Q2
    {0x3664, 0xCC2E, WORD_LEN, 0}, 	// P_G2_P0Q3
    {0x3666, 0xFC71, WORD_LEN, 0}, 	// P_G2_P0Q4
    {0x3680, 0x556E, WORD_LEN, 0}, 	// P_G1_P1Q0
    {0x3682, 0xE44D, WORD_LEN, 0}, 	// P_G1_P1Q1
    {0x3684, 0x424F, WORD_LEN, 0}, 	// P_G1_P1Q2
    {0x3686, 0xD6ED, WORD_LEN, 0}, 	// P_G1_P1Q3
    {0x3688, 0xA012, WORD_LEN, 0}, 	// P_G1_P1Q4
    {0x368A, 0x786E, WORD_LEN, 0}, 	// P_R_P1Q0
    {0x368C, 0xA5ED, WORD_LEN, 0}, 	// P_R_P1Q1
    {0x368E, 0x0790, WORD_LEN, 0}, 	// P_R_P1Q2
    {0x3690, 0x9E68, WORD_LEN, 0}, 	// P_R_P1Q3
    {0x3692, 0xA1F2, WORD_LEN, 0}, 	// P_R_P1Q4
    {0x3694, 0x170A, WORD_LEN, 0}, 	// P_B_P1Q0
    {0x3696, 0x992D, WORD_LEN, 0}, 	// P_B_P1Q1
    {0x3698, 0xA250, WORD_LEN, 0}, 	// P_B_P1Q2
    {0x369A, 0x340E, WORD_LEN, 0}, 	// P_B_P1Q3
    {0x369C, 0x6690, WORD_LEN, 0}, 	// P_B_P1Q4
    {0x369E, 0x76E9, WORD_LEN, 0}, 	// P_G2_P1Q0
    {0x36A0, 0x0FCB, WORD_LEN, 0}, 	// P_G2_P1Q1
    {0x36A2, 0xDF0F, WORD_LEN, 0}, 	// P_G2_P1Q2
    {0x36A4, 0xD54D, WORD_LEN, 0}, 	// P_G2_P1Q3
    {0x36A6, 0xC38B, WORD_LEN, 0}, 	// P_G2_P1Q4
    {0x36C0, 0x6991, WORD_LEN, 0}, 	// P_G1_P2Q0
    {0x36C2, 0xA60F, WORD_LEN, 0}, 	// P_G1_P2Q1
    {0x36C4, 0xB951, WORD_LEN, 0}, 	// P_G1_P2Q2
    {0x36C6, 0xEFF0, WORD_LEN, 0}, 	// P_G1_P2Q3
    {0x36C8, 0x8BB2, WORD_LEN, 0}, 	// P_G1_P2Q4
    {0x36CA, 0x4391, WORD_LEN, 0}, 	// P_R_P2Q0
    {0x36CC, 0xFF0E, WORD_LEN, 0}, 	// P_R_P2Q1
    {0x36CE, 0x9E6F, WORD_LEN, 0}, 	// P_R_P2Q2
    {0x36D0, 0xCD10, WORD_LEN, 0}, 	// P_R_P2Q3
    {0x36D2, 0x8B71, WORD_LEN, 0}, 	// P_R_P2Q4
    {0x36D4, 0x5491, WORD_LEN, 0}, 	// P_B_P2Q0
    {0x36D6, 0xBF6F, WORD_LEN, 0}, 	// P_B_P2Q1
    {0x36D8, 0xEC32, WORD_LEN, 0}, 	// P_B_P2Q2
    {0x36DA, 0x536F, WORD_LEN, 0}, 	// P_B_P2Q3
    {0x36DC, 0x2794, WORD_LEN, 0}, 	// P_B_P2Q4
    {0x36DE, 0x7271, WORD_LEN, 0}, 	// P_G2_P2Q0
    {0x36E0, 0xE16F, WORD_LEN, 0}, 	// P_G2_P2Q1
    {0x36E2, 0xD031, WORD_LEN, 0}, 	// P_G2_P2Q2
    {0x36E4, 0x93AF, WORD_LEN, 0}, 	// P_G2_P2Q3
    {0x36E6, 0x8C32, WORD_LEN, 0}, 	// P_G2_P2Q4
    {0x3700, 0xFAD0, WORD_LEN, 0}, 	// P_G1_P3Q0
    {0x3702, 0x81AF, WORD_LEN, 0}, 	// P_G1_P3Q1
    {0x3704, 0xCFD3, WORD_LEN, 0}, 	// P_G1_P3Q2
    {0x3706, 0x0FF0, WORD_LEN, 0}, 	// P_G1_P3Q3
    {0x3708, 0x0CD6, WORD_LEN, 0}, 	// P_G1_P3Q4
    {0x370A, 0xEE70, WORD_LEN, 0}, 	// P_R_P3Q0
    {0x370C, 0x116F, WORD_LEN, 0}, 	// P_R_P3Q1
    {0x370E, 0xAFB3, WORD_LEN, 0}, 	// P_R_P3Q2
    {0x3710, 0x89F2, WORD_LEN, 0}, 	// P_R_P3Q3
    {0x3712, 0x6235, WORD_LEN, 0}, 	// P_R_P3Q4
    {0x3714, 0xC6F0, WORD_LEN, 0}, 	// P_B_P3Q0
    {0x3716, 0x600F, WORD_LEN, 0}, 	// P_B_P3Q1
    {0x3718, 0x2E70, WORD_LEN, 0}, 	// P_B_P3Q2
    {0x371A, 0xC4D2, WORD_LEN, 0}, 	// P_B_P3Q3
    {0x371C, 0x0853, WORD_LEN, 0}, 	// P_B_P3Q4
    {0x371E, 0x8431, WORD_LEN, 0}, 	// P_G2_P3Q0
    {0x3720, 0x5B8F, WORD_LEN, 0}, 	// P_G2_P3Q1
    {0x3722, 0xACD0, WORD_LEN, 0}, 	// P_G2_P3Q2
    {0x3724, 0xC212, WORD_LEN, 0}, 	// P_G2_P3Q3
    {0x3726, 0x4874, WORD_LEN, 0}, 	// P_G2_P3Q4
    {0x3740, 0xA7B2, WORD_LEN, 0}, 	// P_G1_P4Q0
    {0x3742, 0xCD10, WORD_LEN, 0}, 	// P_G1_P4Q1
    {0x3744, 0xA876, WORD_LEN, 0}, 	// P_G1_P4Q2
    {0x3746, 0x4A33, WORD_LEN, 0}, 	// P_G1_P4Q3
    {0x3748, 0x0099, WORD_LEN, 0}, 	// P_G1_P4Q4
    {0x374A, 0xADB1, WORD_LEN, 0}, 	// P_R_P4Q0
    {0x374C, 0x152E, WORD_LEN, 0}, 	// P_R_P4Q1
    {0x374E, 0x9656, WORD_LEN, 0}, 	// P_R_P4Q2
    {0x3750, 0x82D3, WORD_LEN, 0}, 	// P_R_P4Q3
    {0x3752, 0x5238, WORD_LEN, 0}, 	// P_R_P4Q4
    {0x3754, 0x8652, WORD_LEN, 0}, 	// P_B_P4Q0
    {0x3756, 0x6690, WORD_LEN, 0}, 	// P_B_P4Q1
    {0x3758, 0x9475, WORD_LEN, 0}, 	// P_B_P4Q2
    {0x375A, 0xB134, WORD_LEN, 0}, 	// P_B_P4Q3
    {0x375C, 0x19D8, WORD_LEN, 0}, 	// P_B_P4Q4
    {0x375E, 0xA632, WORD_LEN, 0}, 	// P_G2_P4Q0
    {0x3760, 0xBE2F, WORD_LEN, 0}, 	// P_G2_P4Q1
    {0x3762, 0x9B96, WORD_LEN, 0}, 	// P_G2_P4Q2
    {0x3764, 0x57F2, WORD_LEN, 0}, 	// P_G2_P4Q3
    {0x3766, 0x7C58, WORD_LEN, 0}, 	// P_G2_P4Q4
    {0x3782, 0x0324, WORD_LEN, 0}, 	// CENTER_ROW
    {0x3784, 0x0430, WORD_LEN, 0}, 	// CENTER_COLUMN
    {0x3210, 0x01B8, WORD_LEN, 0}, 	// COLOR_PIPELINE_CONTROL
#elif defined(CONFIG_MACH_RAISE)
...
struct mt9t11x_reg_t mt9t112_regs = {
    ...
    .lens_for_outdoor_tbl   = lens_for_indoor_tbl,
    .lens_for_outdoor_tbl_sz= ARRAY_SIZE(lens_for_indoor_tbl),
};
